...
function Lt(e, t) {
	C$2(e) ? e.push(...t || []) : i(e) && Object.assign(e, t);
}
function ve(e) {
...
function At(e, t = "") {
	return [
		...
		"flex-shrink",
		"order"
	].some((s) => t.endsWith(s)) ? e : `${e}`.trim().split(" ").map((a) => z$1(a) ? `${a}px` : a).join(" ");
}
function dt(e) {
	...
	if (a(e)) {
		...
		if (G(a, k)) {
			let n = a.replaceAll(k, (l) => {
				return `var(${ae(r, re(l.replace(/{|}/g, "").split(".").filter((m) => !s.some((d) => G(m, d))).join("-")))}${s$2(i) ? `, ${i}` : ""})`;
			});
...
var b = {
	...
	getPreset({ name: e = "", preset: t = {}, options: r, params: s, set: i, defaults: a, selector: n }) {
		var f, x, p;
		let l, o, c;
		if (s$2(t) && r.transform !== "strict") {
			let y = e.replace("-directive", ""), m$2 = t, { colorScheme: R, extend: T, css: j } = m$2, O = v(m$2, [
				"colorScheme",
				"extend",
				"css"
			]), d = T || {}, { colorScheme: M } = d, z = v(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v(u, ["dark"]), g = M || {}, { dark: te } = g, re = v(g, ["dark"]), K = s$2(O) ? this._toVariables({ [y]: h(h({}, O), z) }, r) : {}, A = s$2(L) ? this._toVariables({ [y]: h(h({}, L), re) }, r) : {}, X = s$2(V) ? this._toVariables({ [y]: h(h({}, V), te) }, r) : {}, [G, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A.declarations) != null ? x : "", A.tokens || []], [H, W] = [(p = X.declarations) != null ? p : "", X.tokens || []];
	...
	getSelectorRule(e, t, r, s) {
		return r === "class" || r === "attr" ? C(s$2(t) ? `${e}${t},${e} ${t}` : e, s) : C(e, C(t != null ? t : ":root,:host", s));
	},
	transformCSS(e, t, r, s, i$3 = {}, a, n, l) {
		if (s$2(t)) {
			...
			if (s !== "style") {
				...
				t = r === "dark" ? c.reduce((m, { type: d, selector: u }) => (s$2(u) && (m += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m), "") : C(l != null ? l : ":root,:host", t);
			}
			if (o) {
				let c = {
					name: "primeui",
				...
				i(o) && (c.name = m(o.name, {
					name: e,
					type: s
				})), s$2(c.name) && (t = C(`@layer ${c.name}`, t), a?.layerNames(c.name));
			}
			return t;
		}
		return "";
...
//#endregion
export { ht$1 as $, me as A, A as B, ft as C, k as D, je as E, ve as F, R as G, C$1 as H, w as I, W as J, T as K, x as L, oe as M, rr as N, ke as O, ue as P, h$1 as Q, s as R, dt as S, ie as T, P as U, At$1 as V, Q$1 as W, _t as X, Yt as Y, c as Z, ae as _, De as a, C$2 as at, ce as b, Le as c, Y$1 as ct, Nt as d, g$1 as dt, k$1 as et, Q as f, i as ft, Y as g, s$2 as gt, Ve as h, ne$1 as ht, D as i, s$1 as it, ne as j, le as k, Lt as l, a as lt, S as m, m as mt, At as n, v$1 as nt, Dt as o, F$1 as ot, Re as p, l as pt, U as q, C as r, z as rt, E as s, H as st, Ae as t, tt, N as u, c$1 as ut, ar as v, ht as w, de as x, b as y, $$1 as z };

//# sourceMappingURL=dist-BeBsPZWt.js.map
...
//#region node_modules/toastr/toastr.js
var require_toastr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(define) {
			...
			return (function() {
				...
				function notify(map) {
					...
					function handleEvents() {
						...
						if (options.closeButton && $closeElement) $closeElement.click(function(event) {
							if (event.stopPropagation) event.stopPropagation();
							else if (event.cancelBubble !== void 0 && event.cancelBubble !== true) event.cancelBubble = true;
							if (options.onCloseClick) options.onCloseClick(event);
							hideToast(true);
						});
						if (options.onclick) $toastElement.click(function(event) {
					...
					function setSequence() {
						if (options.newestOnTop) $container.prepend($toastElement);
						else $container.append($toastElement);
					}
					function setTitle() {
						if (map.title) {
					...
					function setRTL() {
						if (options.rtl) $toastElement.addClass("rtl");
					}
					function shouldExit(options, map) {
						if (options.preventDuplicates) if (map.message === previousToast) return true;
		...
		if (typeof module !== "undefined" && module.exports) module.exports = factory(require_jquery_bundler_require_wrapper());

import { Dt as mergeProps, G as createBlock, Jt as renderSlot, K as createCommentVNode, M as Fragment, Vt as openBlock, W as createBaseVNode, Yt as resolveComponent, Zt as resolveDynamicComponent, ar as normalizeClass, cn as useId, cr as toDisplayString, et as createVNode, q as createElementBlock, qt as renderList } from "./vue.runtime.esm-bundler-DkHMNSvi.js";
import { Z as c, at as C, dt as g, gt as s, lt as a, m as S, mt as m, ot as F, pt as l, rt as z, u as N, ut as c$1 } from "./dist-BeBsPZWt.js";
import { t as Base } from "./base-Tgx8u0gN.js";
import { t as BaseStyle } from "./style-BX-2E5d3.js";
...
var script$5 = {
	...
	beforeMount: function beforeMount() {
		...
		if (this.rootEl) this.rootEl.$pc = _objectSpread$1({
			name: this.$.type.name,
	...
	methods: {
		...
		_loadGlobalStyles: function _loadGlobalStyles() {
			...
			s(globalCSS) && BaseStyle.load(globalCSS, _objectSpread$1({ name: "global" }, this.$styleOptions));
		},
		_loadThemeStyles: function _loadThemeStyles() {
			...
			if (!S.isStyleNameLoaded("common")) {
				...
				BaseStyle.load(primitive === null || primitive === void 0 ? void 0 : primitive.css, _objectSpread$1({ name: "primitive-variables" }, this.$styleOptions));
				BaseStyle.load(semantic === null || semantic === void 0 ? void 0 : semantic.css, _objectSpread$1({ name: "semantic-variables" }, this.$styleOptions));
				BaseStyle.load(global === null || global === void 0 ? void 0 : global.css, _objectSpread$1({ name: "global-variables" }, this.$styleOptions));
				BaseStyle.loadStyle(_objectSpread$1({ name: "global-style" }, this.$styleOptions), style);
			...
			if (!S.isStyleNameLoaded((_this$$style4 = this.$style) === null || _this$$style4 === void 0 ? void 0 : _this$$style4.name) && (_this$$style5 = this.$style) !== null && _this$$style5 !== void 0 && _this$$style5.name) {
				...
				(_this$$style7 = this.$style) === null || _this$$style7 === void 0 || _this$$style7.load(css, _objectSpread$1({ name: "".concat(this.$style.name, "-variables") }, this.$styleOptions));
				(_this$$style8 = this.$style) === null || _this$$style8 === void 0 || _this$$style8.loadStyle(_objectSpread$1({ name: "".concat(this.$style.name, "-style") }, this.$styleOptions), _style);
		...
		_loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
			...
			this.scopedStyleEl = ((_this$$style1 = this.$style) === null || _this$$style1 === void 0 ? void 0 : _this$$style1.load(css, _objectSpread$1({ name: "".concat(this.$attrSelector, "-").concat(this.$style.name) }, this.$styleOptions))).el;
		},
		...
		_getPTValue: function _getPTValue() {
			...
			var self = searchOut ? void 0 : this._getPTSelf(obj, this._getPTClassValue, key, _objectSpread$1(_objectSpread$1({}, params), {}, { global: global || {} }));
		...
		_getPTDatasets: function _getPTDatasets() {
			...
			return key !== "transition" && _objectSpread$1(_objectSpread$1({}, key === "root" && _objectSpread$1(_objectSpread$1(_defineProperty$1({}, "".concat(datasetPrefix, "name"), g(isExtended ? (_this$pt5 = this.pt) === null || _this$pt5 === void 0 ? void 0 : _this$pt5["data-pc-section"] : this.$.type.name)), isExtended && _defineProperty$1({}, "".concat(datasetPrefix, "extend"), g(this.$.type.name))), {}, _defineProperty$1({}, "".concat(this.$attrSelector), ""))), {}, _defineProperty$1({}, "".concat(datasetPrefix, "section"), g(key)));
		},
		...
		ptmo: function ptmo() {
			...
			var key = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
			var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
			return this._getPTValue(obj, key, _objectSpread$1({ instance: this }, params), false);
		},
		cx: function cx() {
			var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
			var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
		...
		sx: function sx() {
			...
			if (when) {
				...
				return [this._getOptionValue(BaseComponentStyle.inlineStyles, key, _objectSpread$1(_objectSpread$1({}, this.$params), params)), self];
			}
		}
	},
	computed: {
		...
		$_attrsPT: function $_attrsPT() {
			return Object.entries(this.$attrs || {}).filter(function(_ref10) {
				...
				var rest = _arrayLikeToArray$1(_toArray(key.split(":"))).slice(1);
...
//#endregion
//#region node_modules/primevue/breadcrumb/style/index.mjs
var BreadcrumbStyle = BaseStyle.extend({
	...
	classes: {
		...
		item: function item(_ref) {
			...
			return ["p-breadcrumb-item", { "p-disabled": instance.disabled() }];
		},
...
//#endregion
//#region node_modules/primevue/breadcrumb/index.mjs
var script$2 = {
	name: "BaseBreadcrumb",
	"extends": script$5,
	props: {
	...
	computed: {
		...
		getMenuItemProps: function getMenuItemProps() {
			...
			return {
				...
				icon: mergeProps({ "class": [this.cx("icon"), this.item.icon] }, this.ptm("icon", this.ptmOptions)),
				label: mergeProps({ "class": this.cx("label") }, this.ptm("label", this.ptmOptions))
			};
		}
	}
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("nav", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [createBaseVNode("ol", mergeProps({ "class": _ctx.cx("list") }, _ctx.ptm("list")), [_ctx.home ? (openBlock(), createBlock(_component_BreadcrumbItem, mergeProps({
		key: 0,
		item: _ctx.home,

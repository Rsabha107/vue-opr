import { Dt as mergeProps } from "./vue.runtime.esm-bundler-DkHMNSvi.js";
import { $ as ht, G as R, H as C$1, J as W, K as T, L as x, Q as h, R as s, U as P, V as At, W as Q, Y as Yt, at as C, dt as g, et as k, ft as i, ht as ne, lt as a, m as S, mt as m, nt as v, ot as F, pt as l, q as U, rt as z, u as N, ut as c, z as $ } from "./dist-BeBsPZWt.js";
import { t as Base } from "./base-Tgx8u0gN.js";
import { t as BaseStyle } from "./style-BX-2E5d3.js";
import { t as PrimeVueService } from "./service-Ck-bUMvj.js";
...
var BaseDirective = {
	...
	extend: function extend() {
		var _BaseDirective$_getMe2 = _slicedToArray$1(BaseDirective._getMeta.apply(BaseDirective, arguments), 2), name = _BaseDirective$_getMe2[0], options = _BaseDirective$_getMe2[1];
		return _objectSpread({ extend: function extend() {
			var _BaseDirective$_getMe4 = _slicedToArray$1(BaseDirective._getMeta.apply(BaseDirective, arguments), 2), _name = _BaseDirective$_getMe4[0], _options = _BaseDirective$_getMe4[1];
...
//#endregion
//#region node_modules/primevue/tooltip/style/index.mjs
...
//#endregion
//#region node_modules/primevue/tooltip/index.mjs
...
var Tooltip = BaseTooltip.extend("tooltip", {
	beforeMount: function beforeMount(el, options) {
		...
		} else if (_typeof(options.value) === "object" && options.value) if (l(options.value.value) || options.value.value.trim() === "") return;
		else {
	...
	updated: function updated(el, options) {
		...
		if (typeof options.value === "string") {
			...
			target.$_ptooltipAutoHide = true;
			this.bindEvents(target, options);
		} else if (_typeof(options.value) === "object" && options.value) if (l(options.value.value) || options.value.value.trim() === "") {
	...
	methods: {
		...
		unbindEvents: function unbindEvents(el) {
			...
			if (el.$_ptooltipId) this.remove(el);
		},
		...
		onMouseLeave: function onMouseLeave(event) {
			...
			if (!el.$_ptooltipAutoHide) !(Q(event.target, "data-pc-name") === "tooltip" || Q(event.target, "data-pc-section") === "arrow" || Q(event.target, "data-pc-section") === "text" || Q(event.relatedTarget, "data-pc-name") === "tooltip" || Q(event.relatedTarget, "data-pc-section") === "arrow" || Q(event.relatedTarget, "data-pc-section") === "text") && this.hide(el, hideDelay);
		...
		tooltipActions: function tooltipActions(el, options) {
			if (el.$_ptooltipDisabled || !T(el) || !el.$_ptooltipPendingShow) return;
		...
		getArrowElement: function getArrowElement(el) {
			return z(this.getTooltipElement(el), "[data-pc-section=\"arrow\"]");
		},
		...
		alignTop: function alignTop(el) {
			...
			var viewportWidth = h().width;
			var hostOffset = this.getHostOffset(el);
			var left = hostOffset.left + (elementWidth - tooltipWidth) / 2;
			var top = hostOffset.top - C$1(tooltipElement);
			if (left < 0) left = 0;
			else if (left + tooltipWidth > viewportWidth) left = Math.floor(hostOffset.left + elementWidth - tooltipWidth);
			tooltipElement.style.left = left + "px";
			tooltipElement.style.top = top + "px";
		...
		getModifiers: function getModifiers(options) {
			...
			if (options.arg && _typeof(options.arg) === "object") return Object.entries(options.arg).reduce(function(acc, _ref) {
